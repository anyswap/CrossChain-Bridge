...
type GetAccountStateResponse struct {
	...
	Nonce string `protobuf:"varint,2,opt,name=nonce,proto3" json:"nonce,omitempty"`
	// Account type
	Type uint32 `protobuf:"varint,3,opt,name=type,proto3" json:"type,omitempty"`
	// Block height
	Height string `protobuf:"varint,4,opt,name=height,proto3" json:"height,omitempty"`
	// Current sender pending tx count
	Pending string `protobuf:"varint,5,opt,name=pending,proto3" json:"pending,omitempty"`
}
